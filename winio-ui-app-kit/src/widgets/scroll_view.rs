...
use crate::{Result, catch, from_cgsize, transform_cgrect, transform_rect, widgets::Widget};
...
impl ScrollView {
    ...
    pub fn hscroll(&self) -> Result<bool> {
        catch(|| self.view.hasHorizontalScroller())
    }

    pub fn set_hscroll(&mut self, v: bool) -> Result<()> {
        catch(|| self.view.setHasHorizontalScroller(v))
    }

    pub fn vscroll(&self) -> Result<bool> {
        catch(|| self.view.hasVerticalScroller())
    }

    pub fn set_vscroll(&mut self, v: bool) -> Result<()> {
        catch(|| self.view.setHasVerticalScroller(v))
    }
